  ...
  return (
    <div className='dark:bg-gray-900'>
      <div className='max-w-3xl mx-auto text-gray-900 dark:text-white mb-10'>
        <h1 className='text-4xl my-5 text-center'>Privacy Policy</h1>
        ...
        <h3 className='text-lg my-2'>Types of Data Collected</h3>
        ...
        <h3 className='text-lg my-2'>Use of Your Personal Data</h3>
        ...
        <h3 className='text-lg my-2'>Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className='text-lg my-2'>Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className='text-lg my-2'>Disclosure of Your Personal Data</h3>
        ...
        <h3 className='text-lg my-2'>Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className='text-2xl my-5'>Children's Privacy</h2>
        <p>
