  ...
  return (
    <div className='dark:bg-gray-900'>
      ...
      <div className='max-w-3xl mx-auto text-gray-900 dark:text-white mb-10'>
        ...
        <h2 className='text-2xl my-5'>Interpretation and Definitions</h2>
        <h3 className='text-lg my-2'>Interpretation</h3>
        <p>
        ...
        <h3 className='text-lg my-2'>Definitions</h3>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to murmurache.com.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to murmurache.com, accessible from{' '}
              <a
                href='murmurache.com'
        ...
        <h2 className='text-2xl my-5'>Acknowledgment</h2>
        <p>
        ...
        <h2 className='text-2xl my-5'>Termination</h2>
        <p>
        ...
        <h2 className='text-2xl my-5'>Limitation of Liability</h2>
        <p>
        ...
        <h2 className='text-2xl my-5'>Disputes Resolution</h2>
        <p>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>
        <h2 className='text-2xl my-5'>For European Union (EU) Users</h2>
        <p>
          If You are a European Union consumer, you will benefit from any
          mandatory provisions of the law of the country in which you are
          resident in.
        </p>
        <h2 className='text-2xl my-5'>United States Legal Compliance</h2>
        <p>
        ...
        <h2 className='text-2xl my-5'>Severability and Waiver</h2>
        <h2>Severability</h2>
        <p>
        ...
        <h2 className='text-2xl my-5'>Translation Interpretation</h2>
        <p>
          These Terms and Conditions may have been translated if We have made
          them available to You on our Service. You agree that the original
          English text shall prevail in the case of a dispute.
        </p>
        <h2 className='text-2xl my-5'>Changes to These Terms and Conditions</h2>
        <p>
        ...
        <ul>
          <li>
            <p>By email: lucian @ murmurache .com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{' '}
              <a
                href='https://murmurache.com/#contact'
                rel='external noopener noreferrer'
                target='_blank'
              >
                https://murmurache.com/#contact
              </a>
            </p>
          </li>
        </ul>
